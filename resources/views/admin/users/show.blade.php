                            ...
                            <div class="pt-2 border-t border-gray-200">
                                ...
                                <dd class="space-y-2">
                                    <form action="{{ route('admin.users.verify-user', $user) }}" method="POST" class="inline-block w-full">
                                        ...
                                        @method('PATCH')
                                        <button type="submit"
                                                class="w-full inline-flex justify-center items-center rounded-md bg-green-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-green-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-600 transition-colors"
                                                data-confirm-delete="Apakah Anda yakin ingin memverifikasi pengguna '{{ $user->name }}'?">
                                    ...
                                    <form action="{{ route('admin.users.reject-verification', $user) }}" method="POST" class="inline-block w-full">
                                        ...
                                        @method('PATCH')
                                        <button type="submit"
                                                class="w-full inline-flex justify-center items-center rounded-md bg-red-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-red-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-600 transition-colors"
                                                data-confirm-delete="Apakah Anda yakin ingin menolak verifikasi pengguna '{{ $user->name }}'?">
                                            <svg class="mr-1.5 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <div class="pt-2 border-t border-gray-200">
                                ...
                                <dd>
                                    <form action="{{ route('admin.users.reject-verification', $user) }}" method="POST" class="inline-block w-full">
                                        ...
                                        @method('PATCH')
                                        <button type="submit"
                                                class="w-full inline-flex justify-center items-center rounded-md bg-yellow-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-yellow-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-yellow-600 transition-colors"
                                                data-confirm-delete="Apakah Anda yakin ingin membatalkan verifikasi pengguna '{{ $user->name }}'?">
                                            <svg class="mr-1.5 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    @if($user->id !== auth()->id())
                        <form action="{{ route('admin.users.destroy', $user) }}" method="POST" class="w-full">
                            ...
                            <button type="submit"
                                    ...
                                    data-confirm-delete="Apakah Anda yakin ingin menghapus pengguna '{{ $user->name }}'?@if($user->complaints->count() > 0) Pengguna ini memiliki {{ $user->complaints->count() }} keluhan yang akan ikut terhapus.@endif Semua komentar terkait juga akan dihapus permanen.">
                                <svg class="-ml-0.5 mr-1.5 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
