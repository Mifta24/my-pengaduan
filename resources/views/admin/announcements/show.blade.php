            ...
            <div class="bg-white shadow-sm ring-1 ring-gray-900/5 rounded-lg">
                ...
                <div class="px-6 py-4 space-y-3">
                    ...
                    <form action="{{ route('admin.announcements.destroy', $announcement) }}" method="POST" class="w-full">
                        ...
                        @method('DELETE')
                        <button type="submit"
                                data-confirm-delete="Apakah Anda yakin ingin menghapus pengumuman '{{ $announcement->title }}'? Tindakan ini tidak dapat dibatalkan dan semua data terkait akan terhapus permanen."
