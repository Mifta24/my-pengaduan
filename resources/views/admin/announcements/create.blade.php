...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="mb-8">
        ...
        <p class="mt-1 text-sm text-gray-500">
            Buat pengumuman baru untuk warga RT/RW
        </p>
    </div>

    <!-- Form -->
    <form method="POST" action="{{ route('admin.announcements.store') }}" enctype="multipart/form-data" x-data="announcementForm()">
        @csrf
            ...
            <div class="bg-white shadow-sm ring-1 ring-gray-900/5 rounded-lg">
                ...
                <div class="px-6 py-6 space-y-6">
                    ...
                    <div>
                        ...
                        <p class="mt-2 text-sm text-gray-500">Ringkasan akan ditampilkan di daftar pengumuman dan pratinjau</p>
                        @error('summary')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="px-6 py-6">
                    <div>
                        ...
                        <p class="mt-2 text-sm text-gray-500">
                            ...
                            <a href="#" class="text-indigo-600 hover:text-indigo-500" onclick="toggleMarkdownHelp()">Lihat panduan Markdown</a>
                        </p>
                        @error('content')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                            ...
                            <div class="mt-4 space-y-4">
                                ...
                                <div class="flex items-center">
                                    <input id="target_rt" name="target_audience[]" type="checkbox" value="rt"
                                           {{ in_array('rt', old('target_audience', [])) ? 'checked' : '' }}
                                           class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-600">
                                ...
                                <div class="flex items-center">
                                    <input id="target_rw" name="target_audience[]" type="checkbox" value="rw"
                                           {{ in_array('rw', old('target_audience', [])) ? 'checked' : '' }}
                                           class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-600">
                                    <label for="target_rw" class="ml-3 text-sm leading-6 text-gray-900">
                                        Pengurus RW
                                    </label>
                                </div>
                            </div>
                    ...
                    <div>
                        ...
                        <div class="mt-2 flex justify-center rounded-lg border border-dashed border-gray-900/25 px-6 py-10">
                            <div class="text-center">
                                ...
                                <p class="text-xs leading-5 text-gray-600">PDF, DOC, DOCX, JPG, PNG, GIF hingga 10MB per file</p>
                            </div>
                        </div>
