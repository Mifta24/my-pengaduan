...
<div class="space-y-6">
        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500">
                    Laporan detail dan analisis pengguna sistem
                </p>
            </div>
            <div class="flex space-x-3">
                <a href="{{ route('admin.reports.export', ['type' => 'users', 'format' => 'csv'] + request()->all()) }}"
                ...
                <a href="{{ route('admin.reports.export', ['type' => 'users', 'format' => 'json'] + request()->all()) }}"
    ...
    <div class="bg-white shadow rounded-lg">
        <form method="GET" action="{{ route('admin.reports.users') }}" class="px-6 py-4">
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-4 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-xl font-bold text-gray-900">{{ number_format($stats['total']) }}</dd>
                        </dl>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-4 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-xl font-bold text-gray-900">{{ number_format($stats['active']) }}</dd>
                        </dl>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-4 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-xl font-bold text-gray-900">{{ number_format($stats['inactive']) }}</dd>
                        </dl>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-4 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-xl font-bold text-gray-900">{{ number_format($stats['this_month']) }}</dd>
                        </dl>
                    </div>
                </div>
            </div>
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <div class="flex items-center space-x-2">
                                    @if(!$user->email_verified_at)
                                        <span class="inline-flex items-center rounded-md px-2 py-1 text-xs font-medium bg-yellow-50 text-yellow-800 ring-1 ring-inset ring-yellow-600/20">
