...
return [
    ...
    'auth' => [
        ...
        'in' => class_exists('Knuckles\Scribe\Config\AuthIn') ? AuthIn::BEARER->value : 'bearer',
        ...
        'extra_info' => 'Dapatkan token dengan melakukan <b>POST</b> ke <code>/api/login</code> menggunakan email dan password. Token harus disertakan di header <code>Authorization: Bearer {token}</code> untuk semua endpoint yang memerlukan autentikasi.',
    ],
