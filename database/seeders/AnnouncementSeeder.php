...
class AnnouncementSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $adminUsers = User::role(['admin', 'rt', 'rw'])->get();
...
Kami mengundang seluruh warga RT 001/RW 003 untuk menghadiri rapat bulanan yang akan dilaksanakan pada:

**Hari/Tanggal:** Sabtu, 15 Oktober 2025
**Waktu:** 19.30 - 21.00 WIB
**Tempat:** Balai RT 001/RW 003
...
**Pengurus RT 001/RW 003**',
            ...
            [
                ...
                'content' => 'Kepada Yth. Warga RT 001/RW 003
...
Dalam rangka menjaga kebersihan dan kenyamanan lingkungan RT 001/RW 003, kami mengajak seluruh warga untuk berpartisipasi dalam kegiatan gotong royong:
...
**Tim Siaga Bencana RT 001/RW 003**',
                'priority' => 'urgent',
                'target_audience' => ['all'],
                'is_active' => true,
                'is_sticky' => true,
            ...
            [
                ...
                'content' => 'Kepada Orang Tua Balita di RT 001/RW 003
